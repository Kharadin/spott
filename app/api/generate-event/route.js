...
`;
    // const systemPrompt = `You are an expert event planner. Given the user's imput, generate a concise and engaging event desription suitable for an event listing website. Focus on clarity, appeal and essential details that attract potential attendees.`
