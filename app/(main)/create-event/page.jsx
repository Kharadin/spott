...
// there are a few fields that we want to watch.  
const themeColor = watch("themeColor");
const ticketType= watch("ticketType");
const selectedState = watch("state");
// only after state selected, city will be available
// and after selecting startDate, endDate will be available
...
const coverImage = watch("coverImage");
  ...
  return ( 
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-[1fr_auto] gap-2">
                {/* this is invisible, the visible anchor is the button, and then goes the Input of time format */}
                <Popover>
    ...
    {/* Unsplash image picker  */} {showImagePicker && (
      <UnsplashImagePicker
